...
public class ShowTipsBuilder {
	...
	public ShowTipsBuilder setImageResource(int ivResId){
		this.showtipsView.setImageResource(ivResId);
		return this;
	}
	...
	public ShowTipsBuilder isCircle(boolean isCircle){
		this.showtipsView.setIsCircle(isCircle);
		return this;
	}
	...
	public ShowTipsBuilder setRadius(float boundRadius){
		showtipsView.setRadius(boundRadius);
		return this;
	}
